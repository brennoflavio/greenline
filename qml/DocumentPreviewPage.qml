...
Page {
    ...
    Column {
        ...
        Label {
            text: previewPage.documentName || i18n.tr("Document")
            fontSize: "large"
        ...
        IconButton {
            ...
            onClicked: {
                pageStack.push(savePage, {
                    "docUrl": previewPage.documentPath
                });
            }
        }
    ...
    header: PageHeader {
        ...
        title: documentName || i18n.tr("Document")
        leadingActionBar.actions: [
            Action {
                iconName: "back"
                text: i18n.tr("Back")
